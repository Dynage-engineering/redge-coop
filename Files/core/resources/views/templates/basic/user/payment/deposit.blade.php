                        ...
                        <div class="card-body">
                            ...
                            <div class="mt-3 preview-details">
                                <ul class="list-group list-group-flush">
                                    ...
                                    <li class="list-group-item d-flex justify-content-between">
                                        <span class="text-muted">@lang('Payable')</span> <span><span class="payable "> 0</span> {{ __($general->cur_text) }}</span>
                                    </li>
                                    ...
                                    <li class="list-group-item justify-content-center crypto_currency d-none">
                                        <span class="text-muted">@lang('Conversion with') <span class="method_currency"></span> @lang('and final value will Show on next step')</span>
                                    </li>
                                </ul>
                            </div>
